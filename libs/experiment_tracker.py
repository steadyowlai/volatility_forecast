...
if __name__ == "__main__":
    ...
    with experiment_run("test_experiment") as tracker:
        tracker.log_params({
            "learning_rate": 0.01,
            "max_depth": 3,
            "n_estimators": 100
        ...
        tracker.log_artifact("models/model.pkl", "Trained model")
    
    # Method 2: Manual
    tracker = ExperimentTracker("another_test")
    ...
    latest = load_latest_experiment("test_experiment")
    if latest:
